					...
					<div class="section-header">
						...
						<?php
							...
							elseif ( is_customize_preview() ):
								echo '<h2 zerif_hidden_if_not_customizer"></h2>';
							endif;
							...
							if(isset($zerif_contactus_subtitle) && $zerif_contactus_subtitle != ""):
								echo '<div section-legend">'.wp_kses_post( $zerif_contactus_subtitle ).'</div>';
							elseif ( is_customize_preview() ):
								echo '<h6 section-legend zerif_hidden_if_not_customizer">'.$zerif_contactus_subtitle.'</h6>';
							endif;
						?>
					</div>
					<!-- / END SECTION HEADER -->
