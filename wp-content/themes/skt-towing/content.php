  ...
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <header class="entry-header">
      ...
      <div class="postmeta">
        ...
        <div class="post-categories"> &nbsp;|&nbsp;
          <?php the_category( esc_attr__( ', ', 'skt-towing' )); ?>
        </div>
      </div>
      <!-- postmeta -->
      <?php endif; ?>
    ...
    <div class="entry-summary">
      ...
      <p class="read-more"><a href="<?php the_permalink(); ?>">
        <?php esc_html_e('Read More &raquo;','skt-towing'); ?>
        </a></p>
    </div>
    <!-- .entry-summary -->
    <?php else : ?>
    <div class="entry-content">
      <?php the_content( esc_attr__( 'Continue reading <span class="meta-nav">&rarr;</span>', 'skt-towing' ) ); ?>
      <?php
                wp_link_pages( array(
