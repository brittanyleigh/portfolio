...
define('SKT_URL','http://www.sktthemes.net','skt-towing');
define('SKT_THEME_URL','http://www.sktthemes.net/themes','skt-towing');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/towing_documentation/','skt-towing');
define('SKT_PRO_THEME_URL','http://www.sktthemes.net/shop/towing-wordpress-theme/','skt-towing');
define('SKT_THEME_FEATURED_SET_VIDEO_URL','https://www.youtube.com/watch?v=310YGYtGLIM','skt-towing');
define('SKT_LIVE_DEMO','http://sktthemesdemo.net/towing/','skt-towing');
