  ...
  <div class="footer">
    <div class="cols-4">
      <div class="widget-column-1">
        ...
        <p class="parastyle"><?php echo esc_attr( get_theme_mod('contact_add', 'First Floor, Rogger John Building 69 Market Street Hampshire, London UK 7925', 'skt-towing' )); ?></p>
        <?php } ?>
        <div class="phone-no">
          <p>
            ...
            <i class="fa fa-envelope-o"></i> <a href="mailto:<?php echo sanitize_email(get_theme_mod('contact_mail','demo@companyname.com')); ?>"><?php echo esc_attr(get_theme_mod('contact_mail','demo@companyname.com')); ?></a>
            <?php } ?>
          </p>
        </div>
        <div class="clear"></div>
...
<div class="copyright-wrapper">
  <div class="container">
    <div class="design-by"><?php printf( esc_html__( 'Design %1$s %2$s', 'skt-towing' ), 'by : ', '<a href="'.esc_url(SKT_URL).'" rel="nofollow">SKT Themes</a>' ); ?></div>
    <div class="clear"></div>
  </div>
</div>
<?php wp_footer(); ?>
