...
<div class="wrapper-info">
	<div class="col-left">
          ...
          <p><?php esc_attr_e('SKT Towing is an automotive, repair, service industry, call to action and lead generating business, corporate or professional website related WordPress theme which can be used for multipurposes. Can be used for blogging, personal and any other kind of portfolio and photography and eCommerce websites as well. Compatible with WooCommerce, Nextgen Gallery and Contact Form 7 among other plugins. Simple, flexible and Easy to use.','skt-towing'); ?></p>
	...
	<div class="col-right">			
			<div style="text-align:center; font-weight:bold;">
				<hr />
				<a href="<?php echo SKT_LIVE_DEMO; ?>" target="_blank"><?php esc_attr_e('Live Demo', 'skt-towing'); ?></a> | 
				<a href="<?php echo SKT_PRO_THEME_URL; ?>"><?php esc_attr_e('Buy Pro', 'skt-towing'); ?></a> | 
				<a href="<?php echo SKT_THEME_DOC; ?>" target="_blank"><?php esc_attr_e('Documentation', 'skt-towing'); ?></a>
