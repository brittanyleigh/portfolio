...
<div class="signin_wrap">
  <div class="container">
    <div class="widget-left">
      ...
      <span class="emailinfo"><i class="fa fa-envelope-o"></i> <a href="mailto:<?php echo sanitize_email(get_theme_mod('contact_mail','demo@companyname.com')); ?>"><?php echo esc_attr(get_theme_mod('contact_mail','demo@companyname.com')); ?></a></span>
      <?php } ?>
    </div>
    <!--widget-left-->
    <div class="widget-right">
      ...
      <span class="support-27-7"><?php echo esc_attr( get_theme_mod('service_hr', '24/7', 'skt-towing'));?></span>
      <?php } ?>
    </div>
    <!--widget-right-->
...
<?php if(!empty($skt_towing_id_arr)){ ?>
    ...
    <div id="slidecaption<?php echo $i; ?>" class="nivo-html-caption">
      <div class="slide_info">
        ...
        <p><?php the_excerpt(); ?></p>
		<a class="sldbutton" href="<?php the_permalink(); ?>"><?php esc_attr_e('Read More', 'skt-towing');?></a>
      </div>
    </div>
    <?php $i++; } ?>
  <div class="clear"></div>
